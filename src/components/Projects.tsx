...
const projects = [
  ...
  },
  {
    ...
    description:
      'Conception et développement de sites web professionnels pour avocats et commissaires de justice. Interface moderne, accessible et performante avec animations WebGL personnalisées.',
  ...
  },
  {
    ...
    description:
      "Conception de parcours pédagogiques interactifs pour les formations en médecine et pharmacie. Gamification et design UX pour améliorer l'engagement et la rétention d'apprentissage.",
  ...
  },
  {
    ...
    description:
      'Direction artistique et design pour divers clients indépendants. Identités visuelles, sites web sur-mesure, expositions artistiques et résidences créatives internationales.',
  ...
  },
  {
    ...
    description:
      "Projet R&D pour la conception d'un système de vision informatique destiné à la navigation autonome d'un drone. Instrumentation, programmation embarquée et traitement d'images.",
    tech: [
      'Vision Informatique',
      'Arduino (C)',
      "Traitement d'Images",
  ...
  },
  {
    ...
    description:
      "Conception complète d'un système de tests pour récepteurs GPS : montage hardware, développement software de contrôle et acquisition de données, design d'interface ergonomique (IHM).",
  ...
  },
  {
    ...
    description:
      "Étude expérimentale d'un système innovant de chauffage par fluide caloporteur. Mise en place et tests d'un banc de mesure thermique, instrumentation et acquisition de données.",
    ...
    <section id="projects" className="section projects">
      <div className="container">
        ...
        <p className="section-subtitle">
          Quelques réalisations représentatives de mon expertise technique et créative
        </p>
